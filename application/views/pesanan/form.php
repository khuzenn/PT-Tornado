                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" role="form" action="<?= $action; ?>" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="paid" id="paid" placeholder="Masukkan Nominal . . ." autocomplete="off">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control" name="note" id="note" placeholder="" autocomplete="off"></textarea>
