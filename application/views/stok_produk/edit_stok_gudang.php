            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Edit Stok Gudang</div>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" role="form" action="<?= $action; ?>" method="POST">
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="produk" class="form-select" data-control="select2" data-placeholder="Pilih Kategori Produk . . .">
                                    <option value="">Pilih Produk</option>
                                    <?php foreach ($list_produk_name as $produk) : ?>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="stok" placeholder="Masukkan Stok . . ." autocomplete="off" value="<?php if (isset($stok)) echo $stok; ?>">
                            </div>
                          </div>
