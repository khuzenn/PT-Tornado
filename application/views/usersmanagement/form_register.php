            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (isset($registration_fields) && is_array($registration_fields)) { ?>
                            <?php foreach ($registration_fields as $val) { ?>
                                <?php if (count($val) >= 4) { ?>
                                    <?php list($name, $label, $rules, $type) = $val; ?>
                                    <?php $field = array(
                                        'name' => $name,
                                        'id' => $name,
                                    ...
                                    <?php if ($type == 'text') { ?>
                                        <?php $field['size'] = 30; ?>
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label text-end"><?= $field['placeholder'] ?><span style="color:red;">*</span></label>
                                            <div class="col-sm-9">
                                                <?php echo form_input($field, '', 'autocomplete="off"'); ?>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label text-end" for="foto">Foto<span style="color:red;">*</span></label>
                            <div class="col-sm-9">
